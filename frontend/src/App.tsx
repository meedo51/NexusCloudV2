...
import DocuProIFrame from './components/DocuPro/DocuProIFrame';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="studio/docupro-dashboard" element={<DocuProIFrame app="dashboard" />} />
        <Route path="studio/docupro-word" element={<DocuProIFrame app="word" />} />
        <Route path="studio/docupro-excel" element={<DocuProIFrame app="excel" />} />
        <Route path="studio/docupro-pdf" element={<DocuProIFrame app="pdf" />} />
      </Route>
